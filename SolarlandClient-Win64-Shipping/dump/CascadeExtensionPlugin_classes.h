...
struct UForcePointDataProvider : UInterface {
	...
	struct FForcePoints GetForcePoints(); // Function CascadeExtensionPlugin.ForcePointDataProvider.GetForcePoints // (Native|Event|Public|BlueprintEvent|Const) // @ game+0xcc54a0
};
...
struct UMeshDataProvider : UInterface {
	...
	struct FMeshTriangleData GetMeshTriangleData(); // Function CascadeExtensionPlugin.MeshDataProvider.GetMeshTriangleData // (Native|Event|Public|BlueprintEvent|Const) // @ game+0xcc5c50
	int32_t GetDataRevision(); // Function CascadeExtensionPlugin.MeshDataProvider.GetDataRevision // (Native|Event|Public|BlueprintEvent|Const) // @ game+0xcc5c20
};
...
struct UParticleDataProvider : UInterface {
	...
	struct FParticleProperties UpdateParticle(struct FParticleProperties currentParticleProperties); // Function CascadeExtensionPlugin.ParticleDataProvider.UpdateParticle // (Native|Event|Public|BlueprintEvent|Const) // @ game+0xcc6380
	struct FParticleProperties SpawnParticle(struct FParticleProperties currentParticleProperties); // Function CascadeExtensionPlugin.ParticleDataProvider.SpawnParticle // (Native|Event|Public|BlueprintEvent|Const) // @ game+0xcc6280
};
...
struct UParticleModuleLocationMesh : UAbstractParticleModule {
	...
	void OnCachedActorDestroyed(struct AActor* DestroyedActor); // Function CascadeExtensionPlugin.ParticleModuleLocationMesh.OnCachedActorDestroyed // (Final|Native|Private) // @ game+0xcc7370
};
