...
struct ABlockoutToolsParent : AActor {
	...
	void RerunConstructionScript(); // Function BlockoutToolsPlugin.BlockoutToolsParent.RerunConstructionScript // (Final|Native|Private|BlueprintCallable) // @ game+0x827d90
	void BlockoutSetMaterial(); // Function BlockoutToolsPlugin.BlockoutToolsParent.BlockoutSetMaterial // (Final|Native|Private|BlueprintCallable) // @ game+0x827d70
};
